...
const url = "http://api.openweathermap.org/data/2.5/weather?q=Paris&appid=d7cb02b740f69386e6981051514d4b63";
fetch(url, {
  method:"GET"
})
  .then(resp => resp.json())
  ...
  // //The architecture of an API is usually explained from a client and server perspective.
// The application that sends the request is called the client, and the application that sends the response is called the server.
//So, in the weather example, the service database is the server and the mobile app is the client.
